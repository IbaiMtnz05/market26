...
/**
 * Represents a seller user in the marketplace system.
 * Extends User with seller-specific attributes and manages their sales.
 */
...
public class Seller extends User implements Serializable {
	...
	/**
	 * Creates a new seller with the specified details.
	 * 
	 * @param email Seller email address
	 * @param name Seller name
	 * @param bankAccount Bank account number for payments
	 */
	public Seller(String email, String name, String bankAccount) {
	...
	/**
	 * String representation of the seller.
	 * 
	 * @return String with email, name and sales
	 */
