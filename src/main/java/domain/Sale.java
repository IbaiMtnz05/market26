...
/**
 * Represents a sale item in the marketplace system.
 * Contains information about the product being sold, including price, status, and seller.
 */
...
public class Sale implements Serializable {
	 ...
	 * 
	 * @param title Sale title
	 * @param description Product description
	 * @param status Product condition status
	 * @param price Selling price
	 * @param pubDate Publication date
	 * @param file Image file (optional)
	 * @param seller The seller creating this sale
	 */
	 ...
	 * 
	 * @return String with saleNumber, title and price
	 */
