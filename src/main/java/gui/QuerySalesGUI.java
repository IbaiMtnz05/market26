...
/**
 * GUI window for searching and viewing available sales.
 * Allows users to search for sales by title and view details by double-clicking.
 */
		 ...
		 jButtonSearch.addActionListener(new ActionListener() {
		 	public void actionPerformed(ActionEvent e) {
		 		try {
					...
					List<domain.Sale> sales=facade.getSales(jTextFieldSearch.getText());
